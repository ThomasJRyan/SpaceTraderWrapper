...
class TestSystems(unittest.TestCase):
    ...
    def test_get_shipyard(self):
        ...
        self.assertEqual(shipyard.dict(), {'symbol': 'string', 'shipTypes': [{'type': 'SHIP_PROBE'}], 'transactions': [{'waypointSymbol': 'string', 'shipSymbol': 'string', 'price': 1, 'agentSymbol': 'string', 'timestamp': datetime.datetime(2019, 8, 24, 14, 15, 22, tzinfo=datetime.timezone.utc)}], 'ships': [{'symbol': None, 'registration': None, 'nav': None, 'crew': None, 'frame': {'symbol': 'FRAME_PROBE', 'name': 'string', 'description': 'string', 'condition': 0, 'moduleSlots': 0, 'mountingPoints': 0, 'fuelCapacity': 0, 'requirements': {'power': 0, 'crew': 0, 'slots': 0}}, 'reactor': {'symbol': 'REACTOR_SOLAR_I', 'name': 'string', 'description': 'string', 'powerOutput': 1, 'requirements': {'power': 0, 'crew': 0, 'slots': 0}, 'condition': 0}, 'engine': {'symbol': 'ENGINE_IMPULSE_DRIVE_I', 'name': 'string', 'description': 'string', 'requirements': {'power': 0, 'crew': 0, 'slots': 0}, 'speed': 1, 'condition': 0}, 'modules': [{'symbol': 'MODULE_MINERAL_PROCESSOR_I', 'name': 'string', 'description': 'string', 'requirements': {'power': 0, 'crew': 0, 'slots': 0}, 'capacity': 0, 'range': 0}], 'mounts': [{'symbol': 'MOUNT_GAS_SIPHON_I', 'name': 'string', 'description': 'string', 'strength': 0, 'deposits': ['QUARTZ_SAND'], 'requirements': {'power': 0, 'crew': 0, 'slots': 0}}], 'cargo': None, 'fuel': None}]})
        
    def test_get_jump_gate(self):
        jump_gate = self.client.get_jump_gate('string', 'string')
        self.assertEqual(jump_gate.dict(), {'jumpRange': 0, 'factionSymbol': 'string', 'connectedSystems': [{'symbol': 'string', 'sectorSymbol': 'string', 'type': 'NEUTRON_STAR', 'x': 0, 'y': 0, 'distance': 0, 'factionSymbol': 'string'}]})