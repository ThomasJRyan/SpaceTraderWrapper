...
class TestContracts(unittest.TestCase):
    ...
    def test_accept_contract(self):
        ...
        self.assertEqual(contract.dict(), {'agent': {'accountId': 'string', 'symbol': 'string', 'headquarters': 'string', 'credits': 0}, 'contract': {'id': 'string', 'factionSymbol': 'string', 'type': 'PROCUREMENT', 'terms': {'deadline': datetime.datetime(2019, 8, 24, 14, 15, 22, tzinfo=datetime.timezone.utc), 'payment': {'onAccepted': 0, 'onFulfilled': 0}, 'deliver': [{'tradeSymbol': 'string', 'destinationSymbol': 'string', 'unitsRequired': 0, 'unitsFulfilled': 0}]}, 'accepted': False, 'fulfilled': False, 'expiration': datetime.datetime(2019, 8, 24, 14, 15, 22, tzinfo=datetime.timezone.utc)}, 'cargo': None})
        
    def test_deliver_contract(self):
        contract = self.client.deliver_contract('string', 'string', 'string', 0)
        self.assertEqual(contract.dict(), {'agent': None, 'contract': {'id': 'string', 'factionSymbol': 'string', 'type': 'PROCUREMENT', 'terms': {'deadline': datetime.datetime(2019, 8, 24, 14, 15, 22, tzinfo=datetime.timezone.utc), 'payment': {'onAccepted': 0, 'onFulfilled': 0}, 'deliver': [{'tradeSymbol': 'string', 'destinationSymbol': 'string', 'unitsRequired': 0, 'unitsFulfilled': 0}]}, 'accepted': False, 'fulfilled': False, 'expiration': datetime.datetime(2019, 8, 24, 14, 15, 22, tzinfo=datetime.timezone.utc)}, 'cargo': {'capacity': 0, 'units': 0, 'inventory': [{'symbol': 'string', 'name': 'string', 'description': 'string', 'units': 1}]}})
